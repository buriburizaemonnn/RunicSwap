...
import { idlFactory } from './ord_indexer.did.js';
export { idlFactory } from './ord_indexer.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORD_INDEXER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ord_indexer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ord_indexer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ord_indexer.did.js")._SERVICE>}
 */
export const ord_indexer = createActor(canisterId);
