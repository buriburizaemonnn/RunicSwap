...
import { idlFactory } from './swap_backend.did.js';
export { idlFactory } from './swap_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SWAP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./swap_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the swap_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./swap_backend.did.js")._SERVICE>}
 */
export const swap_backend = createActor(canisterId);
